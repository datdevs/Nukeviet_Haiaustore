...
$lang_module['cart_total'] = 'Tổng số tiền';
...
$lang_module['order_view'] = 'Chi tiết đơn hàng';
...
$lang_module['order_print'] = 'In hóa đơn';
...
$lang_module['history_payment_wait'] = '<strong class="text-warning text-uppercase" role="alert">Chờ duyệt đơn hàng</strong>';
$lang_module['history_payment_no'] = '<strong class="text-warning text-uppercase" role="alert">Chưa thanh toán</strong>';
$lang_module['history_payment_send'] = '<strong class="text-info text-uppercase" role="alert">Đã gửi thanh toán</strong>';
$lang_module['history_payment_check'] = '<strong class="text-info text-uppercase" role="alert">Đã thanh toán, đang tạm giữ</strong>';
$lang_module['history_payment_cancel'] = '<strong class="text-danger text-uppercase" role="alert">Bị hoàn trả</strong>';
$lang_module['history_payment_yes'] = '<strong class="text-success text-uppercase" role="alert">Đã thanh toán</strong>';
...
$lang_module['coupons_fill'] = 'Nhập mã giảm giá';
